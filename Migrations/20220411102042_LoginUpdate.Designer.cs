...
namespace website.Migrations
{
    ...
    [Migration("20220411102042_LoginUpdate")]
            ...
            modelBuilder.Entity("website.Models.Performance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HallId = 2,
                            MovieId = 1,
                            startTime = new DateTime(2022, 4, 11, 12, 55, 41, 196, DateTimeKind.Local).AddTicks(2430)
                        },
                        new
                        {
                            Id = 2,
                            HallId = 5,
                            MovieId = 2,
                            startTime = new DateTime(2022, 4, 11, 15, 20, 41, 209, DateTimeKind.Local).AddTicks(6810)
                        },
                        new
                        {
                            Id = 3,
                            HallId = 2,
                            MovieId = 3,
                            startTime = new DateTime(2022, 4, 11, 16, 20, 41, 209, DateTimeKind.Local).AddTicks(6870)
                        },
                        new
                        {
                            Id = 4,
                            HallId = 3,
                            MovieId = 4,
                            startTime = new DateTime(2022, 4, 11, 13, 20, 41, 209, DateTimeKind.Local).AddTicks(6870)
                        },
                        new
                        {
                            Id = 5,
                            HallId = 1,
                            MovieId = 2,
                            startTime = new DateTime(2022, 4, 11, 15, 20, 41, 209, DateTimeKind.Local).AddTicks(6880)
                        });
                });
