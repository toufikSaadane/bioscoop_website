...
namespace website.Migrations
{
    ...
    [Migration("20220405201857_migration4")]
            ...
            modelBuilder.Entity("website.Models.Performance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HallId = 2,
                            MovieId = 1,
                            startTime = new DateTime(2022, 4, 5, 22, 53, 56, 990, DateTimeKind.Local).AddTicks(9890)
                        },
                        new
                        {
                            Id = 2,
                            HallId = 5,
                            MovieId = 2,
                            startTime = new DateTime(2022, 4, 6, 1, 18, 57, 3, DateTimeKind.Local).AddTicks(5730)
                        },
                        new
                        {
                            Id = 3,
                            HallId = 2,
                            MovieId = 3,
                            startTime = new DateTime(2022, 4, 6, 2, 18, 57, 3, DateTimeKind.Local).AddTicks(5790)
                        },
                        new
                        {
                            Id = 4,
                            HallId = 3,
                            MovieId = 4,
                            startTime = new DateTime(2022, 4, 5, 23, 18, 57, 3, DateTimeKind.Local).AddTicks(5800)
                        },
                        new
                        {
                            Id = 5,
                            HallId = 1,
                            MovieId = 2,
                            startTime = new DateTime(2022, 4, 6, 1, 18, 57, 3, DateTimeKind.Local).AddTicks(5800)
                        });
                });
