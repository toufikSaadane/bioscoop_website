...
namespace website.Migrations
{
    ...
    [Migration("20220411094639_CreateIdentitySchema1")]
            ...
            modelBuilder.Entity("website.Models.Performance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HallId = 2,
                            MovieId = 1,
                            startTime = new DateTime(2022, 4, 11, 12, 21, 38, 361, DateTimeKind.Local).AddTicks(6630)
                        },
                        new
                        {
                            Id = 2,
                            HallId = 5,
                            MovieId = 2,
                            startTime = new DateTime(2022, 4, 11, 14, 46, 38, 372, DateTimeKind.Local).AddTicks(7080)
                        },
                        new
                        {
                            Id = 3,
                            HallId = 2,
                            MovieId = 3,
                            startTime = new DateTime(2022, 4, 11, 15, 46, 38, 372, DateTimeKind.Local).AddTicks(7120)
                        },
                        new
                        {
                            Id = 4,
                            HallId = 3,
                            MovieId = 4,
                            startTime = new DateTime(2022, 4, 11, 12, 46, 38, 372, DateTimeKind.Local).AddTicks(7130)
                        },
                        new
                        {
                            Id = 5,
                            HallId = 1,
                            MovieId = 2,
                            startTime = new DateTime(2022, 4, 11, 14, 46, 38, 372, DateTimeKind.Local).AddTicks(7130)
                        });
                });
