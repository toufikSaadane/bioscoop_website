...
namespace website.Migrations
{
    ...
    [Migration("20220405191630_CreateIdentitySchema")]
            ...
            modelBuilder.Entity("website.Models.Performance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HallId = 2,
                            MovieId = 1,
                            startTime = new DateTime(2022, 4, 5, 21, 51, 29, 626, DateTimeKind.Local).AddTicks(7220)
                        },
                        new
                        {
                            Id = 2,
                            HallId = 5,
                            MovieId = 2,
                            startTime = new DateTime(2022, 4, 6, 0, 16, 29, 637, DateTimeKind.Local).AddTicks(6320)
                        },
                        new
                        {
                            Id = 3,
                            HallId = 2,
                            MovieId = 3,
                            startTime = new DateTime(2022, 4, 6, 1, 16, 29, 637, DateTimeKind.Local).AddTicks(6430)
                        },
                        new
                        {
                            Id = 4,
                            HallId = 3,
                            MovieId = 4,
                            startTime = new DateTime(2022, 4, 5, 22, 16, 29, 637, DateTimeKind.Local).AddTicks(6430)
                        },
                        new
                        {
                            Id = 5,
                            HallId = 1,
                            MovieId = 2,
                            startTime = new DateTime(2022, 4, 6, 0, 16, 29, 637, DateTimeKind.Local).AddTicks(6430)
                        });
                });
