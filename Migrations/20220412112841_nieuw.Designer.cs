...
namespace website.Migrations
{
    ...
    [Migration("20220412112841_nieuw")]
    partial class nieuw
    {
            ...
            modelBuilder.Entity("website.Models.Performance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HallId = 2,
                            MovieId = 1,
                            startTime = new DateTime(2022, 4, 12, 14, 3, 41, 592, DateTimeKind.Local).AddTicks(8080)
                        },
                        new
                        {
                            Id = 2,
                            HallId = 5,
                            MovieId = 2,
                            startTime = new DateTime(2022, 4, 12, 16, 28, 41, 626, DateTimeKind.Local).AddTicks(3120)
                        },
                        new
                        {
                            Id = 3,
                            HallId = 2,
                            MovieId = 3,
                            startTime = new DateTime(2022, 4, 12, 17, 28, 41, 626, DateTimeKind.Local).AddTicks(3230)
                        },
                        new
                        {
                            Id = 4,
                            HallId = 3,
                            MovieId = 4,
                            startTime = new DateTime(2022, 4, 12, 14, 28, 41, 626, DateTimeKind.Local).AddTicks(3240)
                        },
                        new
                        {
                            Id = 5,
                            HallId = 1,
                            MovieId = 2,
                            startTime = new DateTime(2022, 4, 12, 16, 28, 41, 626, DateTimeKind.Local).AddTicks(3250)
                        });
                });
