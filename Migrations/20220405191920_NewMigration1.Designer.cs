...
namespace website.Migrations
{
    ...
    [Migration("20220405191920_NewMigration1")]
            ...
            modelBuilder.Entity("website.Models.Performance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HallId = 2,
                            MovieId = 1,
                            startTime = new DateTime(2022, 4, 5, 21, 54, 19, 386, DateTimeKind.Local).AddTicks(3230)
                        },
                        new
                        {
                            Id = 2,
                            HallId = 5,
                            MovieId = 2,
                            startTime = new DateTime(2022, 4, 6, 0, 19, 19, 398, DateTimeKind.Local).AddTicks(1110)
                        },
                        new
                        {
                            Id = 3,
                            HallId = 2,
                            MovieId = 3,
                            startTime = new DateTime(2022, 4, 6, 1, 19, 19, 398, DateTimeKind.Local).AddTicks(1160)
                        },
                        new
                        {
                            Id = 4,
                            HallId = 3,
                            MovieId = 4,
                            startTime = new DateTime(2022, 4, 5, 22, 19, 19, 398, DateTimeKind.Local).AddTicks(1170)
                        },
                        new
                        {
                            Id = 5,
                            HallId = 1,
                            MovieId = 2,
                            startTime = new DateTime(2022, 4, 6, 0, 19, 19, 398, DateTimeKind.Local).AddTicks(1170)
                        });
                });
