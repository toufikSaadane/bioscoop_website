...
namespace website.Migrations
{
    ...
    [Migration("20220410134353_ReviewDb")]
            ...
            modelBuilder.Entity("website.Models.Performance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HallId = 2,
                            MovieId = 1,
                            startTime = new DateTime(2022, 4, 10, 16, 18, 52, 931, DateTimeKind.Local).AddTicks(7480)
                        },
                        new
                        {
                            Id = 2,
                            HallId = 5,
                            MovieId = 2,
                            startTime = new DateTime(2022, 4, 10, 18, 43, 52, 942, DateTimeKind.Local).AddTicks(5530)
                        },
                        new
                        {
                            Id = 3,
                            HallId = 2,
                            MovieId = 3,
                            startTime = new DateTime(2022, 4, 10, 19, 43, 52, 942, DateTimeKind.Local).AddTicks(5570)
                        },
                        new
                        {
                            Id = 4,
                            HallId = 3,
                            MovieId = 4,
                            startTime = new DateTime(2022, 4, 10, 16, 43, 52, 942, DateTimeKind.Local).AddTicks(5580)
                        },
                        new
                        {
                            Id = 5,
                            HallId = 1,
                            MovieId = 2,
                            startTime = new DateTime(2022, 4, 10, 18, 43, 52, 942, DateTimeKind.Local).AddTicks(5580)
                        });
                });
