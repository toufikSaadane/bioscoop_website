...
namespace website.Migrations
{
    ...
    [Migration("20220405133733_migration")]
            ...
            modelBuilder.Entity("website.Models.Performance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HallId = 2,
                            MovieId = 1,
                            startTime = new DateTime(2022, 4, 5, 16, 12, 32, 487, DateTimeKind.Local).AddTicks(9530)
                        },
                        new
                        {
                            Id = 2,
                            HallId = 5,
                            MovieId = 2,
                            startTime = new DateTime(2022, 4, 5, 18, 37, 32, 499, DateTimeKind.Local).AddTicks(6450)
                        },
                        new
                        {
                            Id = 3,
                            HallId = 2,
                            MovieId = 3,
                            startTime = new DateTime(2022, 4, 5, 19, 37, 32, 499, DateTimeKind.Local).AddTicks(6500)
                        },
                        new
                        {
                            Id = 4,
                            HallId = 3,
                            MovieId = 4,
                            startTime = new DateTime(2022, 4, 5, 16, 37, 32, 499, DateTimeKind.Local).AddTicks(6510)
                        },
                        new
                        {
                            Id = 5,
                            HallId = 1,
                            MovieId = 2,
                            startTime = new DateTime(2022, 4, 5, 18, 37, 32, 499, DateTimeKind.Local).AddTicks(6510)
                        });
                });
